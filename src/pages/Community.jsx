...
import MainForm from "../components/community/CommunityMainForm";
            ...
            <div className="community-header">
              <div className="community-header-1">
                ...
                <div style={{ marginRight: "24px" }}>
                  <button onClike={handleWrithButton}>
                    <img
